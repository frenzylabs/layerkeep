...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: :field, hint_clas: :field_hint, error_class: :is_danger, valid_class: :is_success do |b|
    ...
    b.wrapper tag: :div, class: 'control' do |ba|
      ...
      ba.use :error, wrap_with: {tag: :p, class: :is_failure}
    end
  end
