...
export class PrinterEmptyList extends React.Component {
  render() {
    return (
      <Box>
        <Media>
          ...
          <MediaContent style={{textAlign: "center"}}>
            {"You have not added any Printers yet."}
            <br/>
            <Link className="button" to={`/${this.props.params.username}/printers/new`}>New Printer</Link>
          </MediaContent>
